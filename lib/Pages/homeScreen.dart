...
import 'package:furniture_app/Data/globalData.dart';
import 'package:furniture_app/Pages/productScreen.dart';
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  separatorBuilder: (context, index) {
                    return const SizedBox(width: 8); // Adjust the width as per your requirement
                  },
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [                      
                // Picture
                Image.asset("lib/Pictures/${product.picture}.png"),
                Row(
                  children: [
                    Text(
                      product.name,
                    ...
                    const Spacer(),
                    product.isFavourite ? SvgPicture.asset("lib/Icons/heart_filled.svg") 
                    : SvgPicture.asset(
                      "lib/Icons/heart.svg",
                      width: 18,
                      height: 18,
